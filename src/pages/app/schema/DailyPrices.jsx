        ...
        fields: [
            {
                ...
                , fields: [
                    ...
                    {
                        text: 'Material Type', field: 'materialtype', fieldIcon: 'star', placeholder: 'Material type here...', type: 'lookup', required: true, width: 6,
                        schema: {
                            items: [ 
                                { name: 'Gold' },
                                { name: 'Silver' }
                    ...
                    { text: 'Price Date', field: 'priceDate', fieldIcon: 'star', placeholder: 'Price Date here...', type: 'date', required: true, width: 6 },
                    { text: 'Price', field: 'price', fieldIcon: 'star', placeholder: 'Price here...', type: 'text', required: true, width: 6 },
                ]
            },
        ]
    }
